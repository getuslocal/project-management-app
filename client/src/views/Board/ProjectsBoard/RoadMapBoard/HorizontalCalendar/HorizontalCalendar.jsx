    ...
    days.push(
      ...
      >
        ...
        <Day isToday={isToday}>
          ...
          {dateStart.format('D')}
          <Border
            isWeekend={dateStart.day() === 0 || dateStart.day() === 6}
          ></Border>
        </Day>
      </DayCell>
    );
...
const HorizontalCalendar = ({ todayCellRef }) => {
  return <Container>{getCalendarContent(todayCellRef)}</Container>;
};
