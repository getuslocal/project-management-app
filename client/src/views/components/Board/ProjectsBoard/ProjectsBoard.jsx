...
import { selectTickets, selectIsTicketsLoaded } from '../../../../redux/tickets/tickets.selectors';
      ...
      <Container>
        ...
        <Switch>
          <Route exact path={projectUri} render={() =>
            <KanbanBoardWithSpinner isLoading={isLoading} projectInfo={projectInfo} tickets={tickets} />}
          />
